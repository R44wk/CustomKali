# Generated by Powerlevel10k configuration wizard on 2021-03-11 at 00:16 CST. Based on 
# romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 32822. Wizard options: 
# nerdfont-complete + powerline, small icons, rainbow, unicode, angled separators, 
# blurred heads, flat tails, 1 line, sparse, many icons, fluent, instant_prompt=off. 
...
#    taskwarrior             # taskwarrior task count (https://taskwarrior.org/)
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=14
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=92
